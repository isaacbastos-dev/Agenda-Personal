    ...
    return AlertDialog(
      ...
      content: Form(
        ...
        child: TextFormField(
          ...
          validator: (value) {
            if (value!.isEmpty) {
              return 'Informe seu endereço de e-mail';
            }
            return null;
          },
        ),
          ...
          if(_formKey.currentState!.validate()){
            authService.redefinicaoSenha(email: _emailController.text).then((String? erro){
              ...
              if(erro != null) {
                ...
                final snackBar = SnackBar(content: Text('Um link de redefinição de senha foi enviado para o seu e-mail: ${_emailController.text}'),
